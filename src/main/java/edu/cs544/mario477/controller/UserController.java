...
import edu.cs544.mario477.service.*;
...
public class UserController {
    ...
    public UserController(UserService userService,
                          ...
                          AdminService adminService, AdvertisementService advertisementService) {
    ...
    @GetMapping("/{id}/ads")
    public Response advertisements(@PathVariable Long id,
                                   @RequestParam(value = "page", required = false) Integer page,
                                   @RequestParam(value = "size", required = false) Integer size) {
        List<AdvertisementDTO> ads = advertisementService.findAdvertisementMatchWithUser(id);
